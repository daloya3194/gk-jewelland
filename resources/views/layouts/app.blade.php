...
{{--    <div class="bg-red-100 py-2 px-6 text-base text-red-700 inline-flex items-center w-full justify-center shadow-sm" role="alert">
    ...
    <div class="bg-green-100 py-2 px-6 text-green-700 inline-flex items-center justify-center w-full shadow-sm">
