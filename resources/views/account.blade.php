        ...
        <div class="bg-gray-200 h-60 relative flex justify-center">
            ...
            <div class="flex gap-5 absolute -bottom-14 hidden md:inline-flex">
                <div onclick="window.location.href='{{ route('account', [app()->getLocale(), 'account']) }}'"
                     class="bg-white text-center rounded-md shadow-md py-5 px-10 cursor-pointer hover:scale-105 hover:text-bordeaux @if($section == 'account') text-bordeaux @endif">
                ...
                <div onclick="window.location.href='{{ route('account', [app()->getLocale(), 'order']) }}'"
                     class="bg-white text-center rounded-md shadow-md py-5 px-10 cursor-pointer hover:scale-105 hover:text-bordeaux @if($section == 'order') text-bordeaux @endif">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div onclick="window.location.href='{{ route('account', [app()->getLocale(), 'wishlist']) }}'"
                     class="bg-white text-center rounded-md shadow-md py-5 px-10 cursor-pointer hover:scale-105 hover:text-bordeaux @if($section == 'wishlist') text-bordeaux @endif">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="flex absolute bottom-0 md:hidden">
                <a href="{{ route('account', [app()->getLocale(), 'account']) }}"
                   class="px-4 py-2 rounded-sm font-bold cursor-pointer border-r hover:bg-white flex gap-3 items-center @if($section == 'account') bg-white text-bordeaux @else bg-gray-100 @endif"
                >Account</a>
                <a href="{{ route('account', [app()->getLocale(), 'order']) }}"
                   class="px-4 py-2 rounded-sm font-bold cursor-pointer border-r hover:bg-white @if($section == 'order') bg-white text-bordeaux @else bg-gray-100 @endif"
                >Order</a>
                <a href="{{ route('account', [app()->getLocale(), 'wishlist']) }}"
                   class="px-4 py-2 rounded-sm font-bold cursor-pointer hover:bg-white @if($section == 'wishlist') bg-white text-bordeaux @else bg-gray-100 @endif"
                >Wishlist</a>
            </div>
        </div>
